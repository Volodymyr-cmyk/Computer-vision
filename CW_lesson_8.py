...
while True:
    ...
    if not ret:
        break
#________________________________________________dnn_________________________________________________________
    (h, w) = frame.shape[:2]
...
#_______________________________________________cascade______________________________________________________
